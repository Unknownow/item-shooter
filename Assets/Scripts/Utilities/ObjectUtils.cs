...
public static class ObjectUtils
{
    public static Vector3 ClampXPositionToScreen(Vector3 position, Bounds bounds)
    {
        ...
        float minXPointInScreen = CameraManager.mainCamera.ScreenToWorldPoint(Vector2.zero).x;
        float maxXPointInScreen = CameraManager.mainCamera.ScreenToWorldPoint(new Vector2(Screen.width, Screen.height)).x;
    ...
    public static Vector3 ClampYPositionToScreen(Vector3 position, Bounds bounds)
    {
        ...
        float minYPointInScreen = CameraManager.mainCamera.ScreenToWorldPoint(Vector2.zero).y;
        float maxYPointInScreen = CameraManager.mainCamera.ScreenToWorldPoint(new Vector2(Screen.width, Screen.height)).y;
    ...
    public static bool CheckIfSpriteAppearEntirelyInScreen(SpriteRenderer spriteRenderer)
    {
        ...
        Vector2 minScreenPosition = CameraManager.mainCamera.ScreenToWorldPoint(Vector2.zero);
        Vector2 maxScreenPosition = CameraManager.mainCamera.ScreenToWorldPoint(new Vector2(Screen.width, Screen.height));
